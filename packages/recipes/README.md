...
```
按 https://mindbase.me/packages/recipes.README.md 的步骤,把 recipes 应用集成进我本地的 mindbase 仓库,然后 npm run deploy。
```

**源文件位置**:本包的所有源文件已随主仓库一同 clone,位于 `packages/recipes/` 目录;也可从 [https://mindbase.me/packages/recipes.zip](https://mindbase.me/packages/recipes.zip) 下载解压获得。
